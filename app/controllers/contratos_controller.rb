class ContratosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @contrato.update(contrato_params)
        format.html { redirect_to @contrato, notice: 'Contrato modificado com sucesso.' }
  ...
  def destroy
    @contrato.destroy
    respond_to do |format|
      format.html { redirect_to contratos_url, notice: 'Contrato removido com sucesso.' }
  ...
  private
    ...
    def contrato_params
      params.require(:contrato).permit(:cliente_id, :plano_id, :preco_atual, :data_inicio, :data_final, :periodicidade_meses)
    end
end
