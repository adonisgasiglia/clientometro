...
ActiveRecord::Schema.define(version: 20160817224908) do
  ...
  create_table "contratos", force: :cascade do |t|
    ...
    t.integer  "preco_atual_centavos", limit: 4,   default: 0,     null: false
    t.string   "preco_atual_currency", limit: 255, default: "BRL", null: false
    t.date     "data_inicio"
    t.date     "data_final"
